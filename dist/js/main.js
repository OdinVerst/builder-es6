(function () {
	...
	*/
	...
	var testmodule = (function (props) {
	  console.log("\u041C\u043D\u0435 \u043F\u0435\u0440\u0435\u0434\u0430\u043B\u0438 ".concat(props));
	});
	...
	var newArr = concat$2(_context = []).call(_context, arr, [3]);

	var promise$4 = new promise$3(function (resolve, reject) {
	  setTimeout$2(function () {
	    resolve('result');
	  }, 1000);
	});
	promise$4.then(function (result) {
	  alert("Fulfilled: ".concat(result));
	}, function (error) {
	  alert("Rejected: ".concat(error));
	});
